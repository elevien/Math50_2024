...
<ul>
 ...
 <ul>
 <li><a href = "course_documents/Math50-w2M_DRAFT.pdf">Monday (9/23) ROUGH DRAFT</a></li> 
 <li><a href = "course_documents/Math50-w2M_CLASS.pdf">Monday (9/23) Class</a></li>
<li><a href = "course_documents/Math50-w2F_DRAFT.pdf">Friday (9/27) ROUGH DRAFT</a></li>
  </ul></li>
...
<ul>
  <li> <strong>Class notes:</strong>
    ...
    <li><a href = "course_documents/Math50-w3M_DRAFT.pdf">Monday (9/30) ROUGH DRAFT </a> </li>
    </ul>
    </li>
  <li><strong>Code:</strong>
  <ul>
